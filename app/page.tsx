...
const slides = [
  ...
  { url: "https://i.ibb.co/sph647Bv/PXL-20241025-125258053-1-1-1.png", alt: "Art and music programs" },
]
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 container mx-auto px-4 grid md:grid-cols-2 gap-12">
        ...
        <div className="aspect-video w-full rounded-lg overflow-hidden bg-muted">
          <iframe
            src="https://www.youtube.com/embed/WXOgCEuqYs8"
          ...
          <div className="space-y-12 max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="aspect-video relative rounded-lg overflow-hidden">
                <Image
                  src="https://i.ibb.co/k2SnWxxs/PXL-20250214-132711574-1-1-1.png"
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="aspect-video relative rounded-lg overflow-hidden">
                <Image
                  src="https://i.ibb.co/sph647Bv/PXL-20241025-125258053-1-1-1.png"
